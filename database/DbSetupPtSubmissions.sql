...
INSERT INTO `seq`(`service`, `value`) VALUES ('pt', 1);
INSERT INTO `seq`(`service`, `value`) VALUES ('adm', 1);
INSERT INTO `seq`(`service`, `value`) VALUES ('apt', 1);
...
CREATE TABLE `pt_working`  ( 
    `ptWorkingId`                       int(10) UNSIGNED AUTO_INCREMENT NOT NULL,
	`ptUniqueId`                      	int(10) UNSIGNED NOT NULL,
	`ptFirstName`                     	varchar(255) NOT NULL,
	`ptLastName`                      	varchar(255) NOT NULL,
	`ptMiddleName`                    	varchar(255) NOT NULL,
...
CREATE TABLE `pt_submission`  ( 
    `ptSubmissionId`                    int(10) UNSIGNED AUTO_INCREMENT NOT NULL,
	`ptUniqueId`                      	int(10) UNSIGNED NOT NULL,
	`ptFirstName`                     	varchar(255) NOT NULL,
	`ptLastName`                      	varchar(255) NOT NULL,
	`ptMiddleName`                    	varchar(255) NOT NULL,
