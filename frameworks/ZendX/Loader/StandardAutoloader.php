...
class ZendX_Loader_StandardAutoloader implements ZendX_Loader_SplAutoloader
{
    ...
    public static $autoloadDuration = 0;
    public static $autoloadCount = 0;
    public static $autoloadedClasses = array();
    /**
     * Constructor
     *
    ...
    {
        if(strpos(APPLICATION_ENVIRONMENT, 'devel') !== false)
            static::$logging = true;
    ...
    protected function loadClass($class, $type)
    {
        if(static::$logging)
        {
            static::$autoloadedClasses[$type][] = $class;
        ...
        if ($type === self::ACT_AS_FALLBACK) {
            ...
            if (version_compare(PHP_VERSION, '5.3.0', '>=')) {
                ...
                if ($resolvedName !== false) {
                    if(static::$logging)
                    {
                        static::$autoloadDuration += microtime(true) - $start;
                        static::$autoloadCount++;
                    }
